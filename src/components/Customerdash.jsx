...
export default function Customerdash() {
  ...
  var fName = localStorage.getItem("uId");
      ...
      <nav className="flex items-center justify-between flex-wrap bg-violet-300 p-6 shadow-lg">
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-base lg:flex-grow">
            <a href="#customer-dashboard" className="block mt-4 lg:inline-block lg:mt-0 font-semibold text-lg text-black hover:text-white mr-4">
              Home
            </a>
          ...
          <div>
            <a href="/" className="inline-block px-4 py-2 leading-none border rounded font-semibold text-lg text-black border-white hover:border-transparent hover:text-violet-500 hover:bg-white mt-4 lg:mt-0" onClick={coutsign}>Log Out</a>
          </div>
        </div>
      </nav>
