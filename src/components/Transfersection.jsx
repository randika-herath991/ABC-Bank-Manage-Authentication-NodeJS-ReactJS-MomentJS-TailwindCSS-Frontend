...
export default function Transfersection() {
  ...
  const validateForm = () => {
    ...
    if (!destinationAccId) newErrors.destinationAccId = "Transfer Account Number is required.";
  ...
  const transferTransaction = (e) => {
    ...
    console.log("Transfer Amount:- " + transacAmount)
    ...
    axios({
      ...
      toast.error("Error creating transfer transaction: " + error.message);
    }).finally(() => {
      setIsLoading(false);
    });
  }
