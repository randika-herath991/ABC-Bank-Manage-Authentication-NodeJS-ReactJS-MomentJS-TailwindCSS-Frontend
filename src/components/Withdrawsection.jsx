...
export default function Withdrawsection() {
  ...
  const validateForm = () => {
    ...
    if (!destinationAccId) newErrors.destinationAccId = "Withdraw Account Number is required.";
  ...
  const withdrawTransaction = (e) => {
    ...
    console.log("Withdraw Account Number:- " + destinationAccId)
    ...
    axios({
      ...
      toast.error("Error creating withdraw transaction: " + error.message);
    }).finally(() => {
      setIsLoading(false);
    });
  }
